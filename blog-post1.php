...
FROM
	posts p
	LEFT JOIN categories c ON p.category_id = c.id  ORDER BY created_at desc  limit 5  ";
//die($query_post5);
	$result_post5=$corn->query($query_post5);
	$posts5=array();
	while($row=$result_post5->fetch_assoc()){
		$posts5[]=$row;
	}
?>
<!DOCTYPE html>
				...
				<div class="row">
					...
					<div class="col-md-8">
						<div class="section-row sticky-container">
							<div class="main-post">
								<h3><?= $post['title']?></h3>
								<p><b><em><?= $post['decription']?></em></b></p>
								<p><?= $post['contents']?></p>
								<h3>Đăng bởi: <?= $post['name']?></h3>
